...
config.web.hostname = 'demo.simplytextile.com';
config.web.port     = '8083';

config.web.image_server_url = "http://demo.simplytextile.com:8083/";
...
config.db_username = (process.env.ST_DB_USER ? process.env.ST_DB_USER : "textile_demo_user");
config.db_password = (process.env.ST_DB_PASS ? process.env.ST_DB_PASS : "T@rgetSuperSonic4#");
config.db_database = (process.env.ST_DB_NAME ? process.env.ST_DB_NAME : "textile_demo");
